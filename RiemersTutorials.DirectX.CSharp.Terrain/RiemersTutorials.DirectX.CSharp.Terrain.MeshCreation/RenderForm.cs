...
//   Chapter 1 Terrain
//   SubChapter 13 Creating a mesh from your terrain
// </summary>
// --------------------------------------------------------------------------------------------------------------------

namespace RiemersTutorials.DirectX.CSharp.Terrain.MeshCreation
{
    using System;
    ...
    public class RenderForm : Form
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            this.graphicsDevice.Transform.World = Matrix.Translation(-this.triangleGridHeight / 2, -this.triangleGridWidth / 2, 0) * Matrix.RotationZ(angle);
